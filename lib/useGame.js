...
import { WORDS, isValidGuess, randomWord, wordAt } from "./wordlist";
...
export function useGame() {
  ...
  useEffect(() => {
    ...
    const idx = dailyIndexForDate(new Date(), WORDS.length);
  ...
  return {
    ...
    ...state,
    stats,
    setResultOpen: (open) => dispatch({ type: "SET_RESULT_OPEN", open }),
    setHelpOpen: (open) => dispatch({ type: "SET_HELP_OPEN", open }),
    startDaily,
    startPractice,
    restart,
    pushToken,
