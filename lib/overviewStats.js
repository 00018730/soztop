...
export function computeOverview() {
  ...
  const perGame = {
    ...
    // Everything below is unlimited replay, not daily — no streak concept.
    color: { played: color.played, streak: 0 },
    spot: { played: spot.played, streak: 0 },
    memory: { played: memory.played, streak: 0 },
    slide: { played: slide.played, streak: 0 },
